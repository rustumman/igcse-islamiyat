...
It's built as a single self-contained HTML page, and designed around the retrieval-practice techniques from Peter Brown, Henry Roediger & Mark McDaniel's *Make It Stick: The Science of Successful Learning* — closed retrieval cards, generation prompts, an interleaved cumulative quiz, and a spaced-review planner, rather than a flat wall of text to re-read.

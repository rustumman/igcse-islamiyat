/* =========================================================
   ...
   Each page sets window.ROOT (site base URL, e.g. "/" or
   "/igcse-islamiyat/") and window.PAGE (breadcrumb/sidebar
   context) BEFORE this script loads.
   ...
   Every question in the question bank carries

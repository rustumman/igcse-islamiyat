...
window.QUESTION_BANK = [
  { id:"2-1--first-revelation--q1", paper:"paper-1", topic:"topic-2", unit:"2-1", lesson:"first-revelation",
    ...
    correct:3, explain:"The three channels named in 42:51 are inspiration without an intermediary, speech from behind a veil, and through a sent messenger. Studying earlier scripture is how Waraqah ibn Nawfal recognised what was happening — it isn’t itself a channel of revelation." },
  ...
  { id:"2-1--first-revelation--q2", paper:"paper-1", topic:"topic-2", unit:"2-1", lesson:"first-revelation",
    ...
    correct:1, explain:"Jibreel’s command “Iqra” was followed by the opening verses of Surah al-’Alaq (96:1–5) — “Read in the name of your Lord who created...”" },
  ...
  { id:"2-1--first-revelation--q3", paper:"paper-1", topic:"topic-2", unit:"2-1", lesson:"first-revelation",
    ...
    correct:1, explain:"Jibreel reappeared filling the horizon and said ‘O Muhammad, you are the Messenger of Allah, and I am Jibreel,’ and shortly after Surah al-Muddaththir (74:1–5) was revealed, formally launching the Prophet’s public mission." },

  { id:"2-1--first-revelation--q4", paper:"paper-1", topic:"topic-2", unit:"2-1", lesson:"first-revelation",
    q:"What does ‘wahy’ mean in the context of the Qur’an’s revelation?",
  ...
  { id:"2-1--first-revelation--q5", paper:"paper-1", topic:"topic-2", unit:"2-1", lesson:"first-revelation",
    q:"How old was the Prophet Muhammad (pbuh) when he received the first revelation?",
    choices:["25","33","40","63"],
  ...
  { id:"2-1--first-revelation--q6", paper:"paper-1", topic:"topic-2", unit:"2-1", lesson:"first-revelation",
    q:"How many times did Jibreel command ‘Iqra’ before reciting the first verses?",
  ...
  { id:"2-1--first-revelation--q7", paper:"paper-1", topic:"topic-2", unit:"2-1", lesson:"first-revelation",
    q:"What was Khadijah’s immediate response when the Prophet returned home trembling?",
  ...
  { id:"2-1--first-revelation--q8", paper:"paper-1", topic:"topic-2", unit:"2-1", lesson:"first-revelation",
    q:"Who confirmed the identity of the visitor as the angel Jibreel, and predicted future hostility toward the Prophet?",
  ...
  { id:"2-1--first-revelation--q9", paper:"paper-1", topic:"topic-2", unit:"2-1", lesson:"first-revelation",
    q:"Why do Muslims see it as significant that the Qur’an came to a prophet who could not read or write?",
  ...
  { id:"2-1--first-revelation--q10", paper:"paper-1", topic:"topic-2", unit:"2-1", lesson:"first-revelation",
    q:"According to Qur’an 42:51, what is significant about God sending the first revelation through an angel rather than speaking directly?",
  ...
  { id:"2-1--first-revelation--q12", paper:"paper-1", topic:"topic-2", unit:"2-1", lesson:"first-revelation",
    q:"What was Jibreel’s command on the first night in the Cave of Hira, and how many times did he give it?",
    choices:["“Recite the Qur’an,” once","“Iqra” (“Read”), three times","“Rise and warn,” twice","“Cover yourself,” four times"],
    correct:1, explain:"Given three times, each followed by an embrace until the Prophet reached the limit of his endurance." },

  { id:"2-1--first-revelation--q13", paper:"paper-1", topic:"topic-2", unit:"2-1", lesson:"first-revelation",
    q:"Who confirmed the identity of the angel who appeared to the Prophet, and what did he predict?",
    ...
    correct:1, explain:"Waraqah identified Jibreel and foresaw the coming persecution." },
